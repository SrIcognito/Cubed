    ...
    run: async (client, interaction, args) => {
        ...
        const Wikipedia = new MessageEmbed()
            .addField(`${client.languages.__({ phrase: `client.wikipedia.title`, locale: GuildDB.language }, { command: capitalizeFirstLetter(Command.name) })}`, `\u200b
                ...
                ${client.languages.__({ phrase: `client.wikipedia.category`, locale: GuildDB.language }, { category: client.languages.__({ phrase: `client.commands.categories.${Command.category.toLowerCase()}`, locale: GuildDB.language }) })}
